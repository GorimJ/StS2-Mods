...
namespace CharacterTemplate.CharacterTemplateCode.Cards;
...
/// </summary>
[Pool(typeof(CharacterTemplateCardPool))]
public abstract class CharacterTemplateCard(int cost, CardType type, CardRarity rarity, TargetType target) :
