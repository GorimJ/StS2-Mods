...
namespace GachaShopMod.Relics;
    ...
    public class SharpGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/SharpGachaBall.png";
    protected override string BigIconPath => "res://Images/SharpGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/SharpGachaBall.png";
    
    public SharpGachaBallRelic() : base(true) { }
    ...
    public override async Task AfterObtained()
    {
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Sharp>(chosenCard, 2m);
