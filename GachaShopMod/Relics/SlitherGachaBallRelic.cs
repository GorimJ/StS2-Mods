...
namespace GachaShopMod.Relics;
    ...
    public class SlitherGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/SlitherGachaBall.png";
    protected override string BigIconPath => "res://Images/SlitherGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/SlitherGachaBall.png";
    
    public SlitherGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Slither>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Slither>(chosenCard, 1m);
