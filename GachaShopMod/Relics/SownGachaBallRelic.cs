...
namespace GachaShopMod.Relics;
    ...
    public class SownGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/SownGachaBall.png";
    protected override string BigIconPath => "res://Images/SownGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/SownGachaBall.png";
    
    public SownGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Sown>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Sown>(chosenCard, 1m);
