...
namespace GachaShopMod.Relics;
    ...
    public class GoopyGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/GoopyGachaBall.png";
    protected override string BigIconPath => "res://Images/GoopyGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/GoopyGachaBall.png";
    
    public GoopyGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Goopy>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Goopy>(chosenCard, 1m);
