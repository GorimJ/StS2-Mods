...
namespace GachaShopMod.Relics;
    ...
    public class GlamGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/GlamGachaBall.png";
    protected override string BigIconPath => "res://Images/GlamGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/GlamGachaBall.png";
    
    public GlamGachaBallRelic() : base(true) { }
    ...
    public override async Task AfterObtained()
    {
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Glam>(chosenCard, 1m);
