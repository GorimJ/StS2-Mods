...
namespace GachaShopMod.Relics;
    ...
    public class SpiralGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/SpiralGachaBall.png";
    protected override string BigIconPath => "res://Images/SpiralGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/SpiralGachaBall.png";
    
    public SpiralGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Spiral>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Spiral>(chosenCard, 1m);
