...
namespace GachaShopMod.Relics;
    ...
    public class AdroitGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/AdroitGachaBall.png";
    protected override string BigIconPath => "res://Images/AdroitGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/AdroitGachaBall.png";
    
    public AdroitGachaBallRelic() : base(true) { }
    ...
    public override async Task AfterObtained()
    {
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Adroit>(chosenCard, 3m);
