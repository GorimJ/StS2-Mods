...
namespace GachaShopMod.Relics;
    ...
    public class CloneGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/CloneGachaBall.png";
    protected override string BigIconPath => "res://Images/CloneGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/CloneGachaBall.png";
    
    public CloneGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Clone>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Clone>(chosenCard, 1m);
