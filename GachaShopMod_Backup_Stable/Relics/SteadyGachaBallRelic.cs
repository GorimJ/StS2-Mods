...
public class SteadyGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/SteadyGachaBall.png";
    protected override string BigIconPath => "res://Images/SteadyGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/SteadyGachaBall.png";
    
    public SteadyGachaBallRelic() : base(true) { }
    ...
    public override async Task AfterObtained()
    {
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Steady>(chosenCard, 1m);
