...
public class MomentumGachaBallRelic : CustomRelicModel
{
    public override RelicRarity Rarity => RelicRarity.Event;
    public override bool HasUponPickupEffect => true;
    public override string PackedIconPath => "res://Images/MomentumGachaBall.png";
    protected override string BigIconPath => "res://Images/MomentumGachaBall.png";
    protected override string PackedIconOutlinePath => "res://Images/MomentumGachaBall.png";
    
    public MomentumGachaBallRelic() : base(true) { }

    public override async Task AfterObtained()
    {
        EnchantmentModel enchantment = ModelDb.Enchantment<Momentum>();
        ...
        if (chosenCard != null)
        {
            CardCmd.Enchant<Momentum>(chosenCard, 5m);
